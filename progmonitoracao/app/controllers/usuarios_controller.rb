class UsuariosController < ApplicationController
  ...
  before_filter :autenticado?, except: [:new, :create]
  ...
  def index
    ...
    if session[:admin] == true
      ...
      @usuarios = Usuario.all.where(usuario_id: session[:usuario_id])
    end
  ...
  def adm_sim
    ...
    respond_to do |format|
      format.html { redirect_to usuarios_url, notice: 'Usuário alterado para administrador.' }
    end
  end
  ...
  def adm_nao
    ...
    respond_to do |format|
      format.html { redirect_to usuarios_url, notice: 'Usuário alterado para candidato.' }
    end
